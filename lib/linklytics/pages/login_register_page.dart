...
import 'package:my_portfolio_flutter/linklytics/constants/size.dart';
import 'package:my_portfolio_flutter/linklytics/constants/colors.dart';
import 'package:my_portfolio_flutter/linklytics/widgets/otp_verifier_section.dart';
import 'package:my_portfolio_flutter/linklytics/widgets/phone_number_section.dart';
            ...
            child: Column(children: [
              ...
              if (_showVerifier) ...[
                ...
                OtpVerifierSection(
                  ...
                  errorText: _otpError,
                  onPressed: () {
                    _verifyOtp(() => context.goNamed(RouteNames.linklyticsDashboard));
                    // setState(() {
