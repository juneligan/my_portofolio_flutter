...
class CustomColor {
  ...
  static const Color hintDart = Color(0xff666874);
  static const Color yellowSecondary = Color(0xffFFC25C);
  static const Color yellowPrimary = Color(0xffFFA25C);
  static const Color whiteSecondary = Color(0xffEAEAEB);
  static const Color whitePrimary = Color(0xffC8C9CB);
}